...
var jobRetryTimeCycle = require('bpmn-js-properties-panel/lib/provider/camunda/parts/implementation/JobRetryTimeCycle'),
    asyncContinuation = require('bpmn-js-properties-panel/lib/provider/camunda/parts/implementation/AsyncContinuation');
...
module.exports = function(group, element, bpmnFactory, translate,eventBus) {
  ...
  group.entries = group.entries.concat(multiInstanceLoopCharacteristics(element, bpmnFactory, translate,eventBus));
