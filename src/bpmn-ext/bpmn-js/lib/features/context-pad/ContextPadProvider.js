...
import {
  is
} from 'bpmn-js/lib/util/ModelUtil'; //'../../util/ModelUtil';

import {
  isExpanded,
  isEventSubProcess
} from 'bpmn-js/lib/util/DiUtil'; //'../../util/DiUtil';
...
import {
  getChildLanes
} from 'bpmn-js/lib/features/modeling/util/LaneUtil'; //'../modeling/util/LaneUtil';
